...
import { Swords, Eye, EyeOff, CheckCircle, Zap, Target, Shield, Crown, Mail } from "lucide-react";
    ...
    return (
      <div className="min-h-screen relative overflow-hidden bg-background">
        ...
        <div className="relative z-10 min-h-screen flex items-center justify-center p-4">
          <Card className="relative bg-card/95 backdrop-blur-md border-orange-500/30 p-12 max-w-md w-full shadow-xl">
            ...
            <div className="relative z-10 text-center space-y-6">
              <div className="relative inline-block">
                ...
                <div className="absolute inset-0 w-20 h-20 bg-orange-500/10 rounded-full blur-xl mx-auto animate-pulse" />
              </div>
              ...
              <div className="flex items-center justify-center gap-3 pt-4">
                <div className="w-8 h-8 border-2 border-primary/30 border-t-orange-500 rounded-full animate-spin" />
          ...
          <div className="w-full max-w-md space-y-8">
            <div className="text-center space-y-6">
              ...
              <div className="space-y-3">
                <h1 className="font-bebas text-6xl tracking-wider text-foreground">VERIFY EMAIL</h1>
                <div className="flex items-center justify-center gap-2">
                  <Mail className="w-4 h-4 text-primary" />
                  <p className="text-foreground/80 text-base">Check your email for verification code</p>
                  <Shield className="w-4 h-4 text-primary" />
                </div>
                <p className="text-muted-foreground text-sm">
                  We sent a 6-digit code to: <span className="text-orange-500 font-semibold">{pendingEmail}</span>
                </p>
              </div>
            </div>
            ...
            <Card className="relative bg-card/95 backdrop-blur-md border p-8 shadow-2xl"
              ...
              <form onSubmit={handleVerification} className="space-y-6 relative z-10">
                {error && (
                ...
                <div className="space-y-2">
                  <Label htmlFor="verificationCode" className="text-xs font-bold text-white uppercase tracking-wider">
                  ...
                  <Input
                    ...
                    required
                    maxLength={6}
                    className="bg-input/50 text-white placeholder-muted-foreground text-center text-xl tracking-widest font-mono
                ...
                <Button
                  ...
                  className="w-full bg-gradient-to-r
                   ...
                   hover:to-orange-400 text-white font-bebas text-2xl 
                   tracking-wider py-6 shadow-lg shadow-orange-500/20 
              ...
              <div className="mt-6 text-center relative z-10">
                <p className="text-muted-foreground text-sm">
                  ...
                  <button
                    ...
                    className="text-orange-500 hover:text-accent font-semibold transition-colors duration-200"
                  >
                    Go back
                  </button>
                </p>
    ...
    <AlertDescription>{error}</AlertDescription>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  required
                  className="bg-input/50 text-white placeholder-muted-foreground
                  focus:ring-1 transition-all duration-200"
                  style={{
                    borderColor: 'var(--border)',
                    ['--tw-ring-color' as any]: 'var(--ring)',
              ...
              <Button
                ...
                disabled={isLoading}
                 className="w-full bg-gradient-to-r
                   from-orange-600 to-orange-500 hover:from-orange-500
                   hover:to-orange-400 text-foreground font-bebas text-2xl 
                   tracking-wider py-6 shadow-lg shadow-orange-500/20 
                   hover:shadow-orange-400/30 transition-all duration-300 transform hover:scale-[1.02] 
                   active:scale-[0.98]"
              >
