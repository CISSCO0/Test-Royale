        ...
        <div className="max-w-7xl mx-auto space-y-10 w-full px-6">
          ...
          <div className="grid lg:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              ...
              <div className="editor-base h-[400px] max-h-[400px] min-h-[400px] rounded-xl overflow-hidden border-2 border-orange-500/30 shadow-xl bg-card">
                <CodeEditorDisplay 
                  id="base"
            ...
            <div className="space-y-4">
              ...
              <div className="h-[400px] max-h-[400px] min-h-[400px] rounded-xl overflow-hidden border-2 border-orange-500/50 shadow-xl bg-card">
                <CodeEditorDisplay
                  id="tests"
                  value={playerTests}
